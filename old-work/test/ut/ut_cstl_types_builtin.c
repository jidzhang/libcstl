...
{
    cstl_stack_t* pstack_input = malloc(sizeof(cstl_stack_t));
...
{
    cstl_stack_t* pstack_second = NULL;
    bool_t b_output = false;
...
{
    cstl_stack_t* pstack_first = NULL;
    bool_t b_output = false;
...
{
    cstl_stack_t* pstack_input = create_stack(int);
    if (pstack_input == NULL) {
        assert_true(false);
        return;
    }
