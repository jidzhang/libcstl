...
{
    cstl_stack_t* psk = _create_stack("unsigned int");
...
{
    cstl_stack_t* psk = _create_stack("vector_t         <      int>     ");
    assert_true(psk != NULL);
...
{
    cstl_stack_t* psk = malloc(sizeof(cstl_stack_t));
...
void test__create_stack_auxiliary__user_defined(void** state)
{
    ...
    psk = malloc(sizeof(cstl_stack_t));
