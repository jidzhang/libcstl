 ...
 */
extern void stack_init(cstl_stack_t* psk_stack);
 ...
 */
extern void stack_init_copy(cstl_stack_t* psk_dest, const cstl_stack_t* cpsk_src);
 ...
 */
extern void stack_destroy(cstl_stack_t* psk_stack);
 ...
 */
extern void stack_assign(cstl_stack_t* psk_dest, const cstl_stack_t* cpsk_src);
 ...
 */
extern size_t stack_size(const cstl_stack_t* cpsk_stack);
 ...
 *          behavior is undefine.
 */
extern bool_t stack_empty(const cstl_stack_t* cpsk_stack);
 ...
 */
extern void* stack_top(const cstl_stack_t* cpsk_stack);
 ...
 */
extern void stack_pop(cstl_stack_t* psk_stack);
 ...
 */
extern bool_t stack_equal(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
 ...
 */
extern bool_t stack_not_equal(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
 ...
 */
extern bool_t stack_less(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
 ...
 */
extern bool_t stack_less_equal(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
 ...
 *          undefined. if cpsk_first == cpsk_second, then return false.
 */
extern bool_t stack_greater(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
 ...
 *          undefined. if cpsk_first == cpsk_second, then return true.
 */
extern bool_t stack_greater_equal(const cstl_stack_t* cpsk_first, const cstl_stack_t* cpsk_second);
