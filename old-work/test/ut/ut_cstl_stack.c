...
{
    cstl_stack_t* psk = create_stack(int);
...
{
    cstl_stack_t* psk_dest = create_stack(int);
    cstl_stack_t* psk_src = create_stack(int);
...
{
    cstl_stack_t* psk_dest = create_stack(int);
    cstl_stack_t* psk_src = create_stack(double);
...
{
    cstl_stack_t* psk_dest = create_stack(char*);
    cstl_stack_t* psk_src = create_stack(char*);
...
{
    cstl_stack_t* psk_dest = create_stack(cstl_stack_t<int>);
    cstl_stack_t* psk_src = create_stack(cstl_stack_t<signed>);
    cstl_stack_t* psk_elem = create_stack(int);
    ...
    assert_true(stack_size((cstl_stack_t*)stack_top(psk_dest)) == 1);
    stack_pop(psk_dest);
    assert_true(stack_size((cstl_stack_t*)stack_top(psk_dest)) == 0);
    stack_pop(psk_dest);
...
{
    cstl_stack_t* psk_dest = NULL;
    cstl_stack_t* psk_src = NULL;
...
{
    cstl_stack_t* psk_first = create_stack(int);
    cstl_stack_t* psk_second = create_stack(int);
...
{
    cstl_stack_t* psk_first = create_stack(int);
    cstl_stack_t* psk_second = create_stack(double);
