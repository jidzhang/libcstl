 ...
 */
cstl_stack_t* _create_stack(const char* s_typename)
{
    cstl_stack_t* psk_new = NULL;

    assert(s_typename != NULL);

    /* allocate memory for stack */
    if ((psk_new = (cstl_stack_t*)malloc(sizeof(cstl_stack_t))) == NULL) {
        return NULL;
    }
 ...
 */
bool_t _create_stack_auxiliary(cstl_stack_t* psk_stack, const char* s_typename)
{
 ...
 */
void _stack_destroy_auxiliary(cstl_stack_t* psk_stack)
{
    assert(psk_stack != NULL);
 ...
 */
void _stack_push(cstl_stack_t* psk_stack, ...)
{
 ...
 */
void _stack_push_varg(cstl_stack_t* psk_stack, va_list val_elemlist)
{
    assert(psk_stack != NULL);
